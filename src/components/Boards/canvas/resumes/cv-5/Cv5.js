...
import Envelope from '../../../../../assets/cv2-assets/envelope.svg'
import Address from '../../../../../assets/cv2-assets/address.svg'
            ...
            employmentsObjects[index] = {
                item:
                    <Group y={index == 0 ? TotalHeightToAdd + 18 : TotalHeightToAdd + 20} ref={node => { this.employmentsRefs[index] = node }}>
                        <Text y={5} text={this.props.values.employments[index].jobTitle} fontStyle="bold" fontFamily="Montserrat" fontSize="8" />
            ...
            educationsObjects[index] = {
                item:
                    <Group y={index == 0 ? TotalHeightToAdd + 18 : TotalHeightToAdd + 20} ref={node => { this.educationsRefs[index] = node }}>
                        <Text y={5} text={this.props.values.educations[index].degree} fontStyle="bold" fontFamily="Montserrat" fontSize="8" />
            ...
            skillsObjects[index] = {
                item:
                    <Group x={10} y={TotalHeightToAdd + 20} ref={node => { this.skillsRefs[index] = node }} >
                        ...
                        <Rect x={3} y={17} width={this.props.values.skills[index].rating < 100 ? this.props.values.skills[index].rating : 105} height={5} fill="#F0C30E" />
                    </Group>
                ,
        ...
        return (
            <Stage y={this.props.currentPage > 1 ? -650 : 0} fontFamily="Georgia" width={470} height={640} ref={node => { this.stageRef = node }}>
                <Layer ref={node => { this.layer = node }} >
                    {/* Left Side */}
                    <Rect height={this.layer ? this.layer.getClientRect().height : 640} width={150} fill="#2D3039" >
                    </Rect>
                    <Image x={30} y={25} width={80} height={85} image={this.props.values.photo} />
                    {/* Left side content */}
                    {/* Contact Start */}
                    <Group x={10} y={140} ref={node => { this.contactRef = node }} >
                        <Text x={10} text={t("resume.info")} fontFamily="Montserrat" fontStyle="bold" fill="white" fontSize={10} />
                        <Rect x={10} y={14} width={100} height={0.5} fill="white" />
                        {/* Phone number*/}
                    ...
                    <Group x={10} y={this.contactRef ? this.contactRef.getClientRect().height + 150 : 140} ref={node => { this.LangugaesRef = node }}    >
                        <Text x={10} text={t("resume.languages")} fontFamily="Montserrat" fontStyle="bold" fill="white" fontSize={10} />
                        <Rect x={10} y={14} width={100} height={0.5} fill="white" />
                        {/* Language item*/}
                        {/* <Group y={28}>
                    ...
                    <Group x={10} y={this.contactRef ? this.contactRef.getClientRect().height + this.LangugaesRef.getClientRect().height + 160 : 140} ref={node => { this.SkillsRef = node }}    >
                        <Text x={10} text={t("resume.skills")} fontFamily="Montserrat" fontStyle="bold" fill="white" fontSize={10} />
                        <Rect x={10} y={14} width={100} height={0.5} fill="white" />
                        {/* Skill Item */}
                        {/* <Group x={10} y={20} >
                    ...
                    <Group x={170} y={this.PersonalRef ? this.PersonalRef.getClientRect().height + 50 : 40} ref={node => { this.ProfileRef = node }}  >
                        <Text text={t("resume.personalSummary")} y={8} fontSize={13} fontStyle="bold" fontFamily="Montserrat" />
                        <Text width={300} fill="#6b6b6b" text={this.props.values.summary} fontSize={6} y={24} fontFamily="Montserrat" />
                    </Group>
                    {/*  Profile End */}
                    ...
                    <Group x={170} y={this.PersonalRef ? this.PersonalRef.getClientRect().height + this.ProfileRef.getClientRect().height + 60 : 40} ref={node => { this.ProHistoryRef = node }}  >
                        <Text text={t("resume.employmentHistory")} y={8} fontSize={13} fontStyle="bold" fontFamily="Montserrat" />
                        {/* Job Item */}
                        {/* <Group y={25}>
                    ...
                    <Group x={170} y={this.PersonalRef ? this.PersonalRef.getClientRect().height + this.ProfileRef.getClientRect().height + this.ProHistoryRef.getClientRect().height + 70 : 40} ref={node => { this.EducationRef = node }}  >
                        <Text text={t("resume.educationHistory")} y={8} fontSize={13} fontStyle="bold" fontFamily="Montserrat" />
                        {/* Job Item */}
                        {/* <Group y={25}>
                            <Text y={5} text="JOB TITILE" fontStyle="bold" fontFamily="Montserrat" fontSize="9" />
                            <Text y={17} text="Company Name | 2020-2022"  fontFamily="Montserrat" fontSize="6" />
