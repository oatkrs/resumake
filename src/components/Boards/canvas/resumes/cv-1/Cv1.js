            ...
            <Layer y={this.props.currentPage > 1 ? -650 : 0} x={0} ref={node => { this.layer = node }}>
                ...
                >
                    ...
                    <Text
                        ...
                        text={t("resume.phone")}
                        fontSize={9}
                        y={this.addressRef ? 224 + this.addressRef.getClientRect().height : 234} x={25}
                    />
                    {/* Address */}
                    <Text
                ...
                <Group
                    ...
                    y={this.summaryRef ? this.summaryRef.getClientRect().height - 20 : 0}
                >
                    {/* Employment History Title  */}
                    <Text
                        fontFamily="Poppins"
                        fontStyle="bold"
                        text={t("resume.employmentHistory")}
                        y={229} x={125}
                        fontSize={13}
                    />
                    <Rect
                ...
                <Group
                    ...
                    y={this.summaryRef ? ((this.summaryRef.getClientRect().height + this.employmentsRef.getClientRect().height) - 45) : 0}
                >
                    ...
                    <Text
                        ...
                        fontFamily="Poppins"
                        fontStyle="bold"
                        text={t("resume.educationHistory")}
                        y={264} x={125}
                        fontSize={13}
                    />
                    <Rect
