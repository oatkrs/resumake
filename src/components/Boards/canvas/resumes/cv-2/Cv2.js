            ...
            <Stage width={470} height={640} ref={node => { this.stageRef = node }}>
                <Layer ref={node => { this.layer = node }} y={this.props.currentPage > 1 ? -650 : 0} >
                    ...
                    <Group>
                        ...
                        {/* Phone Call */}
                        <Text text={t("resume.phone")} fontSize={9} fontFamily="Poppins" fontStyle="bold" x={180} y={137} />
                        ...
                        <Text text={t("resume.email")} fontSize={9} fontFamily="Poppins" fontStyle="bold" x={270} y={137} />
                        ...
                        <Text text={t("resume.address")} fontSize={9} fontFamily="Poppins" fontStyle="bold" x={355} y={137} />
                    ...
                    <Group y={175} ref={node => { this.summaryRef = node }}>
                        {/* Section Title */}
                        <Text y={5} x={20} width={120} fontFamily="Poppins" fontStyle="bold" fontSize={12} text={t("resume.personalSummary").toUpperCase()}></Text>
                        <Text y={5} x={140} width={300} fontFamily="Poppins" fontSize={8} text={this.props.values.summary}></Text>
                    </Group>
                    {/* Employments  Section */}
                    <Group
                        ...
                        {/* Section Title */}
                        <Text y={10} x={20} width={120} fontFamily="Poppins" fontStyle="bold" fontSize={12} text={t("resume.employmentHistory").toUpperCase()}></Text>
                        {/* Job1 */}
                    ...
                    <Group
                        ...
                        <Rect width={310} height={2} x={140} fill="black" />
                        {/* Section Title */}
                        <Text y={10} x={20} width={120} fontFamily="Poppins" fontStyle="bold" fontSize={12} text={t("resume.educationHistory").toUpperCase()}></Text>
                        {/* Educations */}
                    ...
                    <Group
                        ...
                        <Rect width={310} height={2} x={140} fill="black" />
                        {/* Section Title */}
                        <Text y={10} x={20} width={120} fontFamily="Poppins" fontStyle="bold" fontSize={12} text={t("resume.skills").toUpperCase()}></Text>
                        {/* Skill 1 */}
                        {this.returnSkills()}
                        {/* Educations */}
                    </Group>
